        ...
        <div class="navbar-collapse" id="">
          ...
          <div id="myNav" class="overlay">
            <div class="overlay-content">
              ...
              <a href="customerhomepage.jsp">HOUSE</a>
      ...
      <c:forEach var="house" items="${houses}">
        <div class="box">
          ...
          <div class="detail-box">
            ...
            <a href="/customer_servlet?action=editHouse&&id=${house.getHouseId()}"><button>Sửa thông tin</button></a>
            <a href="/customer_servlet?action=detailHouse&&id=${house.getHouseId()}"><button>Chi tiết</button></a>
            <a href="/customer_servlet?action=deleteHouse&&id=${house.getHouseId()}"><button>Xóa nhà</button></a>
          </div>
        </div>
      </c:forEach>
    </div>
