    ...
    <div class="row">
      ...
      <div class="col-lg-4 col-md-5 ">
        <div class="form_container">
          <form action="owner-servlet" method="post">
            <div>
              <input type="hidden" name="action" value="submitEditHouse" />
              <input type="hidden" name="id" value="${house.getHouseId()}" />
            </div>
            <div>
              <input type="number" name="price" placeholder="Giá" required="required" value="${house.getPrice()}"/>
            </div>
            <div>
              <input type="text" name="area" placeholder="Diện tich" required="required" value="${house.getArea()}" />
            </div>
            <div>
              <input type="text" name="type" placeholder="Loại (căn hộ, nhà đất...)" required="required" value="${house.getType()}" />
            </div>
            <div>
              <input type="text" name="province" placeholder="Địa chỉ (Tỉnh)" required="required" value="${house.getAddress().getProvince()}" />
            </div>
            <div>
              <input type="text" name="district" placeholder="Địa chỉ (Huyện)" required="required" value="${house.getAddress().getDistrict()}" />
            </div>
            <div>
              <input type="text" name="ward" placeholder="Địa chỉ (Phường, xã)" required="required" value="${house.getAddress().getWard()}" />
            </div>
            <div>
              <input type="text" class="message-box" name="description" placeholder="Mô tả" value="${house.getDescription()}" />
            </div>
            <div class="d-flex ">
              <button>
                Hoàn thành
